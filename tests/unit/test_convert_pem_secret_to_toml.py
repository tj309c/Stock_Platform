...
def test_convert_pem_double_quoted_top_level(tmp_path):
    ...
    content = f'KRAKEN_API_KEY = "abc123"\nKRAKEN_API_SECRET = "{pem_content}"\n'
    ...
    assert 'KRAKEN_API_SECRET = """' in new_text or 'BINANCE_API_SECRET = """' in new_text or 'COINBASE_API_SECRET = """' in new_text or 'api_secret = """' in new_text
