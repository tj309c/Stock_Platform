...
def main():
    ...
    RECOMMENDED_KEY_DESC = {
        ...
        'COINBASE_API_KEY': 'Coinbase API Key (for CCXT authenticated endpoints)',
        'COINBASE_API_SECRET': 'Coinbase API Secret (paired with COINBASE_API_KEY)',
        'COINBASE_API_PASSWORD': 'Coinbase API Password (if required by your Coinbase product)',
